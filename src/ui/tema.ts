...
/**
 * Color de la barra del navegador en cada tema. Coincide con el lienzo de `index.css`, que
 * desde D1 sale del token `superficie`: stone-50 en claro, stone-950 en oscuro. Aquí va el
 * hex y no la variable CSS porque esto es un atributo de <meta>, no una regla de estilo.
 */
const COLOR_BARRA: Record<TemaEfectivo, string> = { claro: '#fafaf9', oscuro: '#0c0a09' }
