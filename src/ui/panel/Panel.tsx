  ...
  return (
    <div className="space-y-6">
      ...
      {/* Bloque 3: el CUADRE ya tenía pantalla dentro de Trazabilidad y se reutiliza tal
          ...
          habría significado dos sitios donde teclear el mismo saldo real. El título y la
          introducción se le pasan para que el bloque quede numerado como los otros tres (en
          Trazabilidad conserva sus valores por defecto). */}
      {vista.saldos.length > 0 && (
        <SeccionCuadre
          apuntes={apuntes}
          nombreUbic={nombreUbic}
          titulo="3 · Cuadre"
          introduccion="La comprobación que mira hacia fuera: el saldo calculado contra el que lees en el exchange o en la wallet. Es la misma pantalla que hay en Trazabilidad, con los mismos saldos declarados."
        />
      )}
